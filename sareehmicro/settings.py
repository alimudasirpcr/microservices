"""
Django settings for sareehmicro project.
...
SECRET_KEY = 'django-insecure-&9f+r(!anu9n^=c@td$82+)i5s+o&j(rlg+07&a5ny^)6-c^4j'
...
WSGI_APPLICATION = 'sareehmicro.wsgi.application'
